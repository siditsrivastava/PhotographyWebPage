    ...
    <>
      ...
      <div>
        <div className=" home-section container-fluid">
          ...
          <div className="Line border-t-2 border-white-490 mt-[10rem] sm:mt-[6em] md:mt-[7rem] lg:mt-[9rem] xl:mt-[20rem] flex justify-between p-4 lg:text-xl hidden sm:flex">
